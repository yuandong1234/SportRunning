...
import com.yuong.running.BuildConfig;
...
public class LogUtils {
    ...
    public static void i(String msg) {
        if (isDebug)
            Log.i(TAG, StringUtils.isEmpry(msg));
    }

    public static void d(String msg) {
        if (isDebug)
            Log.d(TAG, StringUtils.isEmpry(msg));
    }

    public static void e(String msg) {
        if (isDebug)
            Log.e(TAG, StringUtils.isEmpry(msg));
    }

    public static void e(String msg, Exception e) {
        if (isDebug)
            Log.w(TAG, StringUtils.isEmpry(msg), e);
    }
    ...
    public static void v(String msg) {
        if (isDebug)
            Log.v(TAG, StringUtils.isEmpry(msg));
    }

    public static void w(String msg) {
        if (isDebug)
            Log.w(TAG, StringUtils.isEmpry(msg));
    }
    ...
    public static void showLargeLog(String logContent, int showLength,
        ...
        if (!isDebug)
            return;
        if (!StringUtils.isString(logContent))
            return;
